 ...
 */
@Repository
public class SicExpireMapper extends BaseMapper<SicExpire, SicExpireExample> {

    /** 这部分代码为自动生成代码, 一般情况无需修改 **/

    private static final String EXTRA_MAPPER = "SicExpireExtMapper."; //自定义SQL时使用该namespace

    private static final String DEFAULT_NAMESPACE = "SicExpireMapper."; //默认的namespace

    public SicExpireMapper(){
