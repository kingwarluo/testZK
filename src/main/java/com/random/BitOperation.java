...
public class BitOperation {
    ...
    public static void main(String[] args) {
        ...
        // 3:  0 0 0 0 0 0 1 1
        // 5:  0 0 0 0 0 1 0 1
        // 相同数字异或=0（表示没有不同），不同数字异或=1（表示有不同）
        // 应用：1、两个数字交换，经过三次异或  2、一个数，对同一另一个数异或两次，可以还原
        int x = 3, y = 5;
        x = x ^ y;
        y = x ^ y;
        x = x ^ y;
        ...
        // -1左移12位补码:11111111 11111111 11110000 00000000
        // -1左移12位反码:11111111 11111111 11100000 00000001
        // -1左移12位原码:10000000 00000000 00011111 11111110
        // -1异或-1<<12
        // -1补码      :11111111 11111111 11111111 11111111
        // -1<<12补码  :11111111 11111111 11110000 00000000
        // -1异或-1<<12:00000000 00000000 00001111 11111111 = 4095
