...
/**
 * 扫描包路径，参考：https://blog.csdn.net/geekjoker/article/details/80497913
 *
 * @author jianhua.luo
 * @date 2020/3/27
 */
public class DefaultClassPathScanner extends ClassPathBeanDefinitionScanner {
    ...
    void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
        ...
        for (BeanDefinitionHolder holder : beanDefinitions) {
            ...
            // 当我们需要动态注入Bean，并给该Bean的属性注入其他Bean时，用RuntimeBeanReference，FactoryBean返回BaseMapper
            definition.getPropertyValues().add("baseMapper", new RuntimeBeanReference(this.defaultBaseMapperFactoryBean));
